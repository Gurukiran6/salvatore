...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public boolean existContact ( String phone) {
        ...
        String sql = "SELECT EXISTS (SELECT * FROM contacts1 WHERE phone='"+phone+"' LIMIT 1)";
    ...
    public Cursor getData(int id) {
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor res =  db.rawQuery( "select * from contacts1 where id="+id+"", null );
        return res;
    }
    ...
    public ArrayList<String> getAllCotacts() {
        ...
        Cursor res =  db.rawQuery( "select * from contacts1 ", null );
        res.moveToFirst();
